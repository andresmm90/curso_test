...
var SimpleHandlerData = /** @class */ (function () {
    function SimpleHandlerData(status, data) {
        this.status = status;
        this.data = data;
        this.type = 'simple';
    }
...
function buildHandler(handlerData) {
    ...
    var type = handlerData.type;
    var builder = handlerBuilders[type];
...
var handlerBuilders = {
    simple: function (_a) {
        ...
        responder.explain = function () { return "respond with status " + status + (data ? " and body \"" + data + "\"" : ""); };
        return responder;
    }
};
